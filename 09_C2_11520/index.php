...
die(mysqli_error($conn));
 ...
 $sql_limit = "select * from user order by username limit
$mulai_dari, $limit";
...
$data[3]; ?></td>
 <td>
 <a
href= "updateUser.php?id=<?php echo $data[0];?>" class="update">Update</a>
 <a
href= "hapusUser.php?id=<?php echo $data[0];?>" class="delete" onclick= "return
...
if($page != $i){
 ...
 <a href="tambahUser.php" button class="btn btnwarning"
